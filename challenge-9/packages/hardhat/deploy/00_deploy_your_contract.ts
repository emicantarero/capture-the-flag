...
const deployYourContract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  await balloons.transfer("0x1E588C3F47D21FD787aA506E6313dc0D60745B1B", "" + 10 * 10 ** 18);
  ...
  await balloons.approve(dexAddress, hre.ethers.parseEther("0"));
  console.log("INIT exchange...");
  await dex.init(hre.ethers.parseEther("0"), {
